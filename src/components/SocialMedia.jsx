...
function LinkedInIconBlack(props) {
  return (
    <svg 
      ...
      viewBox="0 0 512 509.64" aria-hidden="true" {...props}>
    <path
      fillRule="evenodd" 
      clipRule="evenodd"  
      fill="#fff"
...
export const socialMediaProfiles = [
  { title: 'LinkedIn', href: 'https://linkedin.com', icon: LinkedInIconWhite },
